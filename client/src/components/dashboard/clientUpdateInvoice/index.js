...
class Clientformupdate extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <h2>
          <strong style={{ paddingLeft: 50 }}><img style={{width:80, marginLeft:90}} src={require('../../image/logo.jpg')} />UPDATE INVOICE</strong>
        </h2>
        <img
